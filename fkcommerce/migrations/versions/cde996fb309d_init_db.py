...
Revision ID: cde996fb309d
Revises: 
Create Date: 2024-10-26 09:19:55.545117
...
def upgrade():
    ...
    sa.Column('season_event', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['category_id'], ['category.id'], ),
    sa.ForeignKeyConstraint(['season_event'], ['season_event.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('alternative_text', sa.String(length=255), nullable=False),
